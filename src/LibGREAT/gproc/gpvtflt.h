    ...
    */
    ...
    public:
        ...
        */
        ...
        /** @brief get PDOP from internal DOP computation */
        double pdop();
    ...
    protected:
        ...
        map<string, double> _crt_ele;      ///< crt elevation (deg)
        map<string, double> _crt_azi;      ///< crt azimuth (rad)
        ...
        t_flt_rec _last_flt;              ///< last .flt record
    };
