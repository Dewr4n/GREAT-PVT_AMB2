    ...
    */
    ...
    public:
        ...
        */
        ...
        // Store results of transformation for external use
        int dim = 0;                  ///< dimension of current ambiguity set
        std::vector<double> Zt;       ///< Z^T transformation matrix (row-major)
        std::vector<double> Az;       ///< transformed float ambiguities
        std::vector<double> Qz;       ///< covariance matrix in decorrelated space
