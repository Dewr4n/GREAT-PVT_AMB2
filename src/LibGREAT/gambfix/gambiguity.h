...
namespace great
{
    ...
    */
    ...
    protected:
        ...
        std::vector<double> _elev_each;           ///< per-satellite elevation angles (deg)
        double _avg_elev = 0.0;                   ///< average satellite elevation (deg)
        std::vector<double> _snr_each;            ///< per-satellite SNR (dB-Hz)
        double _avg_snr = 0.0;                    ///< average SNR (dB-Hz)
        std::vector<double> _sion_each;           ///< slant ionosphere delays (m) from float solution
        double _sion_avg = 0.0;                   ///< averaged slant ionosphere delay (m)
